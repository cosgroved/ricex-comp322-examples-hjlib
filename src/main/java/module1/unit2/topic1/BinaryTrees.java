...
public class BinaryTrees {
    ...
    private static void performComputation(final int maxDepth, final int stretchDepth) throws SuspendableException {
    ...
    private static class TreeNode {
        ...
        private static TreeNode bottomUpTree(final int item, final int depth) {
            ...
            if (depth > 0) {
                final HjFuture<TreeNode> LNode = futureNb(() -> bottomUpTree(2 * finalItem - 1, finalDepth - 1));
                final HjFuture<TreeNode> RNode = futureNb(() -> bottomUpTree(2 * finalItem, finalDepth - 1));
        ...
        private int itemCheck() throws SuspendableException {
